public class Task3to7 {
    ...
    public static void main(String[] args) {
        try {
            ...
            switch (task) {
                case 3:
                    minAll(Integer.parseInt(args[1]), Integer.parseInt(args[2]), Integer.parseInt(args[3]));
                    break;
                case 4:
                    division(Integer.parseInt(args[1]));
                    break;
                case 5:
                    isDivide(Integer.parseInt(args[1]), Integer.parseInt(args[2]));
                    break;
                case 6:
                    nearestTo10(Integer.parseInt(args[1]), Integer.parseInt(args[2]));
                    break;
                case 7:
                    flat(Integer.parseInt(args[1]));
                    break;
                default:
                    System.out.println("ERROR. Check the value (from 3 to 7)");
                    break;
            }
