...
public class Main {
    ...
    public static int getMinValue(int[] m)
    {
        int min = m[0];
    ...
    public static int[] getMinValues(int[] m)
    {
        int[] m1 = new int[2];
    ...
    public static int getChet(int a, int b)
    {
        if(a%b==0)
        {
            return 1;
    ...
    public static int getValueCloseTo10(int a1, int a2)
    {
    ...
    public static long setCash(int a)
    {
        long cash = 40 * a;
        if(a > 7)
        {
